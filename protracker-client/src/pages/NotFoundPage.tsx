    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-950 text-center px-6">
      ...
      {user?.role !== 'Athlete' && (
        <div className="mt-8 flex items-center gap-5 text-sm">
          <Link to="/dashboard" className="text-gray-400 hover:text-indigo-400 transition-colors">Dashboard</Link>
          <Link to="/players" className="text-gray-400 hover:text-indigo-400 transition-colors">Players</Link>
          <Link to="/teams" className="text-gray-400 hover:text-indigo-400 transition-colors">Teams</Link>
        </div>
      )}
    </div>
  );
